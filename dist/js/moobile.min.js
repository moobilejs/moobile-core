...
(function (global){
"use strict";var moobile=global.moobile=global.Moobile={version:"0.3.0"};
...
!function(){var n="animationend",t="transitionend";Element.NativeEvents[n]=2,Element.NativeEvents[t]=2,Element.Events.transitionend={base:t,onAdd:function(){},onRemove:function(){}},Element.Events.animationend={base:n,onAdd:function(){},onRemove:function(){}},Element.defineCustomEvent("owntransitionend",{base:"transitionend",condition:function(n){return n.stop(),n.target===this}}),Element.defineCustomEvent("ownanimationend",{base:"animationend",condition:function(n){return n.stop(),n.target===this}})}();
...
Browser.Features.Touch||function(){var e=!1,t=function(t,o){if("touchstart"==o)e=!0;else if("touchend"==o)e=!1;else if("touchmove"==o&&!e)return!1;return t.targetTouches=[],t.changedTouches=t.touches=[{pageX:t.page.x,pageY:t.page.y,clientX:t.client.x,clientY:t.client.y}],!0};Element.defineCustomEvent("touchstart",{base:"mousedown",condition:t}).defineCustomEvent("touchmove",{base:"mousemove",condition:t}).defineCustomEvent("touchend",{base:"mouseup",condition:t}),document.addEvent("mouseup",function(){e=!1})}();

},{}],64:[function(require,module,exports){
Browser.Features.iOSTouch&&function(){var e="click";delete Element.NativeEvents[e],Element.defineCustomEvent(e,{base:"touch"})}();
