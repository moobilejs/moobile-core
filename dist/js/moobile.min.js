...
(function (global){
"use strict";var moobile=global.moobile=global.Moobile={version:"0.3.17"};
...
!function(){var e,t,n="swipe",i=n+":distance",a=n+":cancelVertical",o=50,c={},u=function(){t=!1},r={touchstart:function(e){if(!(e.touches.length>1)){var n=e.touches[0];t=!0,c={x:n.pageX,y:n.pageY}}},touchmove:function(u){if(!e&&t){var r=u.changedTouches[0],s={x:r.pageX,y:r.pageY};if(this.retrieve(a)&&Math.abs(c.y-s.y)>10)return void(t=!1);var h=this.retrieve(i,o),f=null,v=s.x-c.x,d=s.y-c.y;Math.abs(v)>Math.abs(d)?-h>v?f="left":v>h&&(f="right"):-h>d?f="up":d>h&&(f="down"),f&&(u.preventDefault(),t=!1,u.direction=f,u.start=c,u.end=s,this.fireEvent(n,u))}},touchend:u,touchcancel:u};Element.defineCustomEvent(n,{onSetup:function(){this.addEvents(r)},onTeardown:function(){this.removeEvents(r)},onEnable:function(){e=!1},onDisable:function(){e=!0,u()}})}();
