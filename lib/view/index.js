...
View.at = function(path, options, name) {
	...
	if (element) {
		return Component.create(View, element, 'data-view', options, name);
	}
 ...
 * @since  0.1.0
 */
Component.defineRole('view', null, null, function(element) {
	this.addChildComponent(Component.create(View, element, 'data-view'));
});
 ...
 * @since  0.2.0
 */
Component.defineRole('content', View, {traversable: true}, function(element) {
 ...
 * @since  0.2.0
 */
Component.defineRole('content-wrapper', View, {traversable: true}, function(element) {
 ...
 * @since  0.1.0
 */
Component.defineRole('view-content', View, {traversable: true}, function(element) {
 ...
 * @since  0.1.0
 */
Component.defineStyle('dark', View, {
 ...
 * @since  0.1.0
 */
Component.defineStyle('light', View, {
