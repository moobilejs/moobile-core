...
var Native = moobile.Scroller.Native = new Class({
	...
	initialize: function(contentElement, contentWrapperElement, options) {
		...
		this.contentScrollerElement.on('touchstart', this.bound('_onTouchStart'));
		this.contentScrollerElement.on('touchmove', this.bound('_onTouchMove'));
		this.contentScrollerElement.on('touchend', this.bound('_onTouchEnd'));
		this.contentScrollerElement.on('scroll', this.bound('_onScroll'));

		window.on('orientationchange', this.bound('_onOrientationChange'));
	...
	destroy: function() {
		...
		this.contentScrollerElement.off('touchstart', this.bound('_onTouchStart'));
		this.contentScrollerElement.off('touchend', this.bound('_onTouchMove'));
		this.contentScrollerElement.off('touchend', this.bound('_onTouchEnd'));
		this.contentScrollerElement.off('scroll', this.bound('_onScroll'));
