...
var ViewControllerStack = moobile.ViewControllerStack = new Class({
	...
	pushViewController: function(viewController, viewTransition) {
		...
		viewTransition.on('start:once', this.bound('_onPushTransitionStart'));
		viewTransition.on('complete:once', this.bound('_onPushTransitionComplete'));
	...
	popViewController: function() {
		...
		viewTransition.on('start:once', this.bound('_onPopTransitionStart'));
		viewTransition.on('complete:once', this.bound('_onPopTransitionComplete'));
