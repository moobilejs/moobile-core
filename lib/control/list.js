...
var List = moobile.List = new Class({
	...
	setSelectedItem: function(selectedItem) {
		...
		if (this.__selectedItem) {
			...
			this.emit('deselect', this.__selectedItem);
			this.__selectedItem = null;
		}
		...
		if (selectedItem) {
			...
			this.emit('select', this.__selectedItem);
		}
	...
	didAddChildComponent: function(component) {
		...
		if (component instanceof moobile.ListItem) {
			component.on('tapcancel', this.bound('__onItemTapCancel'));
			component.on('tapstart', this.bound('__onItemTapStart'));
			component.on('tapend', this.bound('__onItemTapEnd'));
			component.on('tap', this.bound('__onItemTap'));
		}
	},
	...
	didRemoveChildComponent: function(component) {
		this.parent(component);
		if (component instanceof moobile.ListItem) {
			component.off('tapcancel', this.bound('__onItemTapCancel'));
			component.off('tapstart', this.bound('__onItemTapStart'));
			component.off('tapend', this.bound('__onItemTapEnd'));
			component.off('tap', this.bound('__onItemTap'));
		}
	},
