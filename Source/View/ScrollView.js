	...
	_snapToPage: function() {
		...
		if (moveX > snapToPageAt || this._activeTouchDuration < snapToPageDelay) {
			switch (this._activeTouchDirectionX) {
				case 'rg': pageX += 1; break;
				case 'lf': pageX -= 1; break;
			}
		}

		if (moveY > snapToPageAt || this._activeTouchDuration < snapToPageDelay) {
			switch (this._activeTouchDirectionY) {
				case 'tp': pageY -= 1; break;
				case 'bt': pageY += 1; break;
			}
		}
